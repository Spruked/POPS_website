...
export const WEBSITE_LEXICON: WebsiteLexiconEntry[] = [
  {
    ...
    metaDescription: "Plain-English POPS Lexicon definition of culpable with court-safe wording for fatherhood records and evidence review.",
  },
  {
    term: "Exculpatory",
    slug: "exculpatory",
    ...
    metaDescription: "POPS Lexicon explains exculpatory evidence in plain English for custody records, court packets, and evidence preservation.",
  },
  {
    term: "Pro se",
    slug: "pro-se",
    ...
    metaDescription: "Plain-English POPS Lexicon definition of pro se for fathers organizing records while representing themselves in court.",
  },
  {
    term: "Prima facie",
    slug: "prima-facie",
    ...
    metaDescription: "POPS Lexicon defines prima facie in plain English with court-safe wording for documented parenting-time records.",
  },
  {
    term: "Estoppel",
    slug: "estoppel",
    ...
    metaDescription: "POPS Lexicon explains estoppel in plain English and how to preserve agreement, reliance, and communication records.",
  },
  {
    term: "Habeas corpus",
    slug: "habeas-corpus",
    ...
    metaDescription: "POPS Lexicon defines habeas corpus as a high-sensitivity legal term requiring careful attorney review before use.",
  },
  {
    ...
    metaDescription: "POPS Lexicon explains Fifth Amendment concerns for statements, accusations, investigations, and court-safe records.",
  },
  {
    ...
    metaDescription: "POPS Lexicon explains Fourteenth Amendment due process and equal protection language for parental-rights records.",
  },
  {
    term: "Due process",
    slug: "due-process",
    ...
    metaDescription: "POPS Lexicon defines due process and the records fathers can preserve around notice, hearings, and court procedure.",
  },
  {
    ...
    metaDescription: "POPS Lexicon explains equal protection in plain English with factual record-preservation guidance for review.",
  },
];
